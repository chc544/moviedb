...
if (!empty($_POST["data"])) {
    ...
    $sql = "INSERT INTO movie (movName, movDesc, movRelDate, movRating, movActors, movProducers, movCategory, movType, movReview) VALUES (:movName, :movDesc, :movRelDate, :movRating, :movActors, :movProducers, :movCategory, :movType, :movReview)";
    $bind = [":movName" => $data["movName"],
        ":movDesc" => $data["movDesc"], ":movRelDate" => $data["movRelDate"],
        ":movRating" => $data["movRating"], ":movActors" => $data["movActors"],
        ":movProducers" => $data["movProducers"], ":movCategory" => $data["movCategory"],
        ":movType" => $data["movType"], ":movReview" => $data["movReview"]];
...
<?php include 'includes/top.php'; ?>
    ...
    <form method="post" action="insert.php">
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                <div class="form-group">
                    <label for="movCategory">Categories*</label>
                    <div class="inner-addon right-addon">
                        <i class="glyphicon fas fa-theater-masks"></i>
                        <select class="selectpicker" name="data[movCategory]" id="movCategory"
